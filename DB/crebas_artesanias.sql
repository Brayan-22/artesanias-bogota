...
drop index ubicacion_almacen_FK;

drop index tienda_almacen_FK;

drop index Almacen_PK;

drop table Almacen;

drop index ubicacion_tienda_FK;
...
drop index ubicacion_cliente_FK;

drop index usuario_cliente_FK;

drop index cliente_PK;

drop table cliente;

drop index usuario_empleado_FK;

drop index tienda_empleado_FK;

drop index rol_empleado_FK;
...
drop index almacen_producto2_FK;
...
drop index orden_producto2_FK;

drop index orden_producto_PK;

drop table orden_producto;

drop index pago_metodo_FK;

drop index orden_pago_FK;
